        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <el-card>
              ...
              <v-chart class="chart" :option="lineChartOption" :loading="lineChartLoading" autoresize />
            </el-card>
          </el-col>
          ...
          <el-col :span="12">
            <el-card>
              ...
              <v-chart class="chart" :option="barChartOption" :loading="barChartLoading" autoresize />
            </el-card>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20" style="margin-top: 20px;">
          ...
          <el-col :span="12">
            <el-card>
              ...
              <v-chart class="chart" :option="pieChartOption" :loading="pieChartLoading" autoresize />
            </el-card>
          </el-col>
          ...
          <el-col :span="12">
            <el-card>
              ...
              <v-chart class="chart" :option="scatterChartOption" :loading="scatterChartLoading" autoresize />
            </el-card>
          </el-col>
        </el-row>
  ...
  series: [
    {
      ...
      type: 'line',
      smooth: true,
      data: Array.from({ length: 20 }, () => Math.round(Math.random() * 50))
    },
    {
      name: '内存使用率',
      type: 'line',
      smooth: true,
      data: Array.from({ length: 20 }, () => Math.round(Math.random() * 70))
    }
  ]
})
...
function refreshLineChart() {
  ...
  setTimeout(() => {
    lineChartOption.value.series[0].data = Array.from({ length: 6 }, () => Math.round(Math.random() * 300))
    lineChartOption.value.series[1].data = Array.from({ length: 6 }, () => Math.round(Math.random() * 400))
...
function refreshBarChart() {
  ...
  setTimeout(() => {
    barChartOption.value.series[0].data = Array.from({ length: 4 }, () => Math.round(Math.random() * 250))
    barChartOption.value.series[1].data = Array.from({ length: 4 }, () => Math.round(Math.random() * 350))
...
function toggleRealTimeChart() {
  ...
  if (realTimeChartActive.value) {
    realTimeInterval = setInterval(() => {
      ...
      // 触发更新
      realTimeChartOption.value = { ...realTimeChartOption.value }
    }, 1000)
  } else {
    if (realTimeInterval) {
