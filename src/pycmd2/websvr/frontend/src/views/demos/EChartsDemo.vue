...
<script setup lang="ts">
  ...
  function refreshLineChart() {
    ...
    setTimeout(() => {
      lineChartOption.value.series[0].data = Array.from({ length: 6 }, () =>
        Math.round(Math.random() * 300)
      );
      lineChartOption.value.series[1].data = Array.from({ length: 6 }, () =>
  ...
  function refreshBarChart() {
    ...
    setTimeout(() => {
      barChartOption.value.series[0].data = Array.from({ length: 4 }, () =>
        Math.round(Math.random() * 250)
      );
      barChartOption.value.series[1].data = Array.from({ length: 4 }, () =>
