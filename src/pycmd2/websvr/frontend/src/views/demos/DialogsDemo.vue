  ...
  <div class="demo-container">
    ...
    <el-row :gutter="20" class="demo-section">
      <el-col :span="12">
        <el-card header="不允许拖动和关闭">
          <el-button type="text" @click="noDragDialogVisible = true">
            打开对话框
          </el-button>

          <el-dialog v-model="noDragDialogVisible" title="提示" width="30%" :draggable="false"
            :close-on-click-modal="false" :close-on-press-escape="false" :show-close="false">
            <span>这个对话框不允许拖动，也不允许点击遮罩层和按ESC键关闭</span>
            <template #footer>
              <span class="dialog-footer">
                <el-button type="primary" @click="noDragDialogVisible = false">
                  确认
                </el-button>
              </span>
            </template>
      ...
      <el-col :span="12">
        <el-card header="对话框内容滚动的设置">
          <el-button type="text" @click="scrollDialogVisible = true">
            打开对话框
          </el-button>

          <el-dialog v-model="scrollDialogVisible" title="提示" width="500" fullscreen>
            <div class="scroll-content">
              <p v-for="i in 20" :key="i">这是第 {{ i }} 行内容，用于测试滚动效果。当内容超出对话框高度时，会出现滚动条。</p>
            </div>
          </el-dialog>
        </el-card>
      </el-col>
      ...
      <el-col :span="24">
        <el-card header="确认消息框">
          <div class="button-group">
            <el-button type="success" @click="openConfirm1">
              成功消息确认框
            </el-button>
            <el-button type="warning" @click="openConfirm2">
              警告消息确认框
            </el-button>
            <el-button type="info" @click="openConfirm3">
              消息确认框
            </el-button>
            <el-button type="danger" @click="openConfirm4">
              错误消息确认框
            </el-button>
          </div>
        </el-card>
    ...
    <el-row :gutter="20" class="demo-section">
      <el-col :span="24">
        <el-card header="提交内容">
          <div class="button-group">
            <el-button type="primary" @click="openPrompt">
              消息提示
            </el-button>
            <el-button type="success" @click="openPrompt2">
              提交内容
            </el-button>
          </div>
        </el-card>
